...
function chamberLabel(c) { return c === 'S' ? 'Senate' : 'House'; }
function chamberPrefix(c) { return c === 'S' ? 'Sen.' : 'Rep.'; }
function districtLabel(l) { return `${l.chamber === 'S' ? 'SD' : 'HD'}-${l.district}`; }
...
function officeShort(o) { return `${o.room} ${buildingShort(o.building)}`; }
...
Object.assign(window, {
  Icon,
  partyLabel, chamberLabel, chamberPrefix, districtLabel,
