...
Currently used by:
  - tests/fixtures/palegis/    — scripts/scrape-palegis.py
...
Two modes:
    ...
    python scripts/refetch-fixtures.py --source palegis
        Restrict to one source dir (skip the others). Useful when one
        drift workflow is responsible for one source.
"""
...
SIGNATURE_CONFIG: dict[str, dict] = {
    "palegis": {
        ...
        "substrings": {
            "js_email_block_present": ["var Name", "var Domain", "var Ext"],
        },
        "href_counts": {
            "bio_links": "/members/bio/",
            "bill_links": "/legislation/bills/",
        },
    },
    "pjm": {
        "selectors": [
